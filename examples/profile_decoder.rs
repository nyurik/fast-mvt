...
//! Usage:
//! ```
//! cargo run --release --example profile_decoder -- fixtures/mvt-fixtures/real-world/bangkok/12-3194-1890.mvt
//! cargo flamegraph --example profile_decoder -- fixtures/mvt-fixtures/real-world/bangkok/12-3194-1890.mvt
//! ```
use std::env;
